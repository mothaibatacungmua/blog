...
stb:{[d;tbn;zpt] sd:(d,"/",string zpt[0]),tbn;$[isPathExist[sd];(hsym`$sd) upsert zpt[1];(hsym`$sd) set .Q.en[hsym`$d;zpt[1]]];neg[.z.w](enlist[`processed]! enlist string zpt[0]);}
...
tcsvpt:{[d;f;tbn] csvpt[d;f;"/",tbn,"/"];system "l ",(d);neg[.z.w]("TASK_DONE");}